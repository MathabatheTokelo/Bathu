                ...
                SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      HistoryText(
                          str:
                              (widget.ab.List1[0]['secparagraph5']).toString()),
                      HistoryText(
                          str: (widget.ab.List1[0]['thirdparagraph1'])
                              .toString()),
                      HistoryText(
                          str: (widget.ab.List1[0]['thirdparagraph2'])
                              .toString()),
                      HistoryText(
                          str: (widget.ab.List1[0]['thirdparagraph3'])
                              .toString()),
                      HistoryText(
                          str: (widget.ab.List1[0]['thirdparagraph4'])
                              .toString()),
                    ],
                  ),
                ),
